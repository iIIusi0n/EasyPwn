...
var file_api_chatbot_proto_goTypes = []interface{}{
...
func file_api_chatbot_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_chatbot_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_chatbot_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
