...
const (
	User_AuthLogin_FullMethodName  = "/easypwn.User/AuthLogin"
	User_CreateUser_FullMethodName = "/easypwn.User/CreateUser"
	User_GetUser_FullMethodName    = "/easypwn.User/GetUser"
	User_UpdateUser_FullMethodName = "/easypwn.User/UpdateUser"
	User_DeleteUser_FullMethodName = "/easypwn.User/DeleteUser"
)
...
func (c *userClient) AuthLogin(ctx context.Context, in *AuthLoginRequest, opts ...grpc.CallOption) (*AuthLoginResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthLoginResponse)
	err := c.cc.Invoke(ctx, User_AuthLogin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedUserServer) AuthLogin(context.Context, *AuthLoginRequest) (*AuthLoginResponse, error) {
...
func _User_AuthLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).AuthLogin(ctx, req.(*AuthLoginRequest))
	}
